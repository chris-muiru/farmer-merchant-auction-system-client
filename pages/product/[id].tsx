...
const ProductDetail = () => {
	return (
		<div className="flex flex-row w-3/4 m-auto">
			<div className="flex flex-col w-full m-auto space-y-4 bg-slate-100 rounded-lg relative min-h-auto">
				<div className="relative h-20 mt-3">
					<h2 className="text-green-500 text-2xl text-center mt-4">
						This is the product being sold
					</h2>
					<button className="absolute bg-green-600 w-[200px] right-3 top-1 text-white h-14 rounded-md">
					...
					<div className=" space-y-4">
						...
						<div className="">
							...
							<button className="border border-green-500 mt-4 flex relative justify-center items-center m-auto rounded-md h-[40px] w-full">
								...
								<HiChat className="text-green-600 text-2xl absolute top-[4px] right-[84px]" />
							</button>
						</div>
					</div>
				</div>
				...
				<div className="p-2 m-2 leading-loose text-justify">
					...
					odio ducimus quibusdam, laboriosam natus atque reprehenderit
					suscipit voluptatibus delectus reiciendis incidunt dolorum ex
					iusto ut facilis. Veritatis quae at rem? Lorem ipsum dolor sit,
					amet consectetur adipisicing elit. Quibusdam cumque quod itaque.
					Quod odio quidem mollitia illum et distinctio odit! Excepturi
					animi quidem repudiandae. Fuga consequatur cupiditate velit
					beatae illum! Lorem ipsum dolor sit amet consectetur adipisicing
					elit. Molestiae impedit dolorem molestias, et quisquam
					praesentium explicabo velit quaerat minima quidem, unde, quo eum
					vitae sequi similique voluptatibus odit officia dignissimos.
				</div>
